...
const Contact = () => {
  ...
  return (
    <>
      <Header />
      <div
        className="grid grid-rows-2 pt-12 lg:pt-0 bg-main-light-blue w-full lg:grid-cols-2 lg:h-[75vh]"
        id="contact"
      >
        {!isSent ? (
          <form
            onSubmit={handleSubmit}
            className="rows-span-1 my-8 md:mt-6 lg:mt-0 flex items-center justify-center lg:cols-span-1 lg:h-[65vh]"
          >
            <fieldset className="border-2 rounded-lg w-[330px] p-5 border-[#567fa9]">
              <legend className="text-2xl text-center text-[#3d5e7f] font-bold 2xl:text-4xl">
                Kontaktiere Uns
              </legend>
              <div className="relative w-[330px] mt-2 xl:mt-0 xl:min-w-[180px] sm:w-[400px] md:w-[550px] lg:w-[360px] xl:w-[450px] 2xl:w-[600px] xl:mx-1 text-main-dark-blue">
                <svg
              ...
              <div className="relative w-[330px] mt-4 xl:min-w-[180px] sm:w-[400px] md:w-[550px] lg:w-[360px] xl:w-[450px] 2xl:w-[600px] xl:mt-6 text-main-dark-blue">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <div className="relative w-[330px] mt-4 xl:mt-6 xl:min-w-[180px] sm:w-[400px] md:w-[550px] lg:w-[360px] xl:w-[450px] 2xl:w-[600px] xl:mx-1 text-main-dark-blue">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  className="w-6 h-6 text-gray-400 absolute left-3 inset-y-0 mt-3"
                >
                  <path
                    fillRule="evenodd"
          ...
          <h1 className="rows-span-1 text-2xl my-8 text-center px-3 flex items-center justify-center lg:cols-span-1 lg:h-[65vh] lg:text-3xl xl:px-6">
            Ihre Nachricht ist gesendet worden. Wir werden uns schnellstmöglich
            bei Ihnen melden.{" "}
          </h1>
        )}
