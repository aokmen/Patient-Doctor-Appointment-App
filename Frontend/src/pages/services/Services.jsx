...
const Services = () => {
  let servicesNameArr = [
    "Online Terminebuchung",
    "Arzt - Anmeldung & Profilverwaltung",
    "Patienten - Anmeldung & Profilverwaltung",
    "Kommunikation zwischen Patient und Arzt",
    "Benachrichtiguns- & Erinnerungsdienst",
    "Bewertung & Kommentare von Ärzten",
    "Datensichereit & Gewährleistung der Sicherheit",
    "Datenschutz Vertraulichkeit von Patientendaten",
  ];
  let serviceImgArr = [
    appoint,
    doctor,
  ...
  return (
    <>
      <Header />
      <div className="flex flex-wrap justify-center items-center w-full min-h-[140vh] bg-main-light-blue">
        ...
        <img className='w-[400px] md:w-[600px] xl:w-[900px] rounded-full border-b-4 lg:border-r-8 service1 bg-main-light-blue' src={serviceImg1} alt="services1" />
      </div> */}
      ...
      <div className='w-[400px] mt-[55rem] sm:mt-[58rem] md:mt-[65rem] lg:mt-[50rem] xl:mt-[30rem] md:w-[600px] xl:w-[900px] md:ml-[10rem] lg:ml-[50rem] xl:ml-[61rem] absolute'>
        <img className='service2 w-[400px] md:w-[600px] xl:w-[900px] rounded-full border-t-4 lg:border-l-8 bg-main-light-blue ' src={serviceImg2} alt="services2" />
      </div> */}
        ...
        <div className="xl:flex-1 flex flex-wrap justify-center xl:w-1/2 ">
          {serviceObjArr.map((item, index) => (
            <div
              key={index}
              className="w-[130px] h-[125px] flex flex-col  bg-white items-center text-center rounded-lg service-card py-1 mx-1 sm:mx-3 sm:my-4 mt-3 md:mt-6 md:w-[150px] md:h-[150px] md:my-0 md:ml-12 lg:h-[160px]"
            >
              <img
                src={item.serImg}
                alt="appointment"
                className="w-8 h-8 mt-3 lg:w-12 lg:h-12"
              />
              <h3 className="text-sm md:text-lg lg:text-lg mt-2 text-[#345b83]">
                {item.serName}
              </h3>
            </div>
          ))}
