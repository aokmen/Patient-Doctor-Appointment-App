  ...
  return (
    <div className="register-form-page h-[90vh] md:h-[88vh] md:py-11 text-center flex flex-col items-center">
      ...
      <form
        ...
        className="register-form mt-4 md:mt-10 xl:mt-0 flex flex-col items-center justify-center"
      >
        ...
        <button
          type="submit"
          className="flex justify-center register-button duration-150 mx-auto md:mt-6"
        >
          REGISTRIEREN
        </button>
      </form>
