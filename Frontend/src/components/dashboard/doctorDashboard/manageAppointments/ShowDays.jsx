...
const ShowDays = ({
  ...
  return (
    <div className="flex justify-center items-center w-full">
      <h3 htmlFor="days" className="text-2xl w-[10rem]">
        {name}
      </h3>
      <div className="w-full flex item-center ml-12 mt-5" id="days">
        <div className="w-full md:w-1/6 pr-3 mb-6 md:mb-0">
          ...
          <div className="relative">
            <div
              name="startHour"
              className="block appearance-none w-full bg-white border-2 border-main-dark-blue text-gray-700 py-3 px-4 pr-8 rounded-lg leading-tight"
              id="grid-state"
            >
              <p>{startHour}</p>
            </div>
        ...
        {/* {
                  receivedAppThisDoctor.length !== 0 ?   //!Burasi normalde calisiyor ama istersen silemeyecek sekilde düzeltirsin
                      ...
                      : */}
        <button
          className="md:w-[10rem] md:h-[3rem] bg-red-600 rounded-xl text-white mt-5 hover:bg-red-500 duration-150"
          onClick={() => delData("weekdays", id)}
        >
          LÖSCHEN
        </button>
        {/* } */}
