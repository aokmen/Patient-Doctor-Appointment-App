  ...
  return (
    <div className="h-[100vh] w-[87vw]">
      <div className="flex justify-center rounded-3xl">
        <div className="bg-white rounded-l-3xl max-h-[86vh] w-[40vw] max-w-[40vw] border-r-[1.9rem] border-main-light-blue min-h-[86vh] flex flex-col overflow-scroll">
          ...
          <div className=" rounded-3xl max-h-[33vh] min-h-[32vh] mt-5 flex flex-col">
            <h1 className="text-3xl text-main-dark-blue mx-auto border-b-2 border-main-dark-blue px-10 my-3">
              Feiertage
            </h1>
            <Feiertage
                  ...
                  <table className="bg-slate-100 mx-auto my-5 border-2 border-main-dark-blue">
                    <thead>
                      <tr>
                        <th
                          colSpan="2"
                          className="w-[120px] text-center border-2 border-main-dark-blue p-2 text-lg"
                        >
                          Termine am {selectedDate || dateToday.split("T")[0]}
                        </th>
                      </tr>
                      <tr>
                        <th className="w-[120px] text-center border-2 border-main-dark-blue p-2">
                          Uhrzeit
                        </th>
                        <th className="w-[120px] text-center border-2 border-main-dark-blue p-2">
                          Patient
