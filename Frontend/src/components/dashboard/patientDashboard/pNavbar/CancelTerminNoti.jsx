...
const CancelTerminNoti = ({
  ...
  return (
    <div className="relative px-6 py-3 flex-auto max-w-[30rem] min-w-[30rem]">
      {isOpened === false ? (
        <div className="bg-red-200 dark:bg-red-900 dark:text-main-light-blue py-6 px-3 rounded-lg flex justify-between">
        ...
        <div className="bg-red-100 p-2 rounded-lg">
          ...
          <p className="my-4 text-blueGray-500">
            Der Termin ist von der Ärztin/dem Arzt storniert worden.
          </p>
          <hr />
          <div className="flex justify-between">
            ...
            <button
              className="bg-main-dark-blue text-white mt-3 active:bg-emerald-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
              type="button"
