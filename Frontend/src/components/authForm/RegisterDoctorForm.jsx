...
export const registerSchema = object().shape({
  ...
  street: string().required("Straße ist verpflichted"),
  zipCode: string().required("PLZ ist verpflichted"),
  branch: string().required("Branch ist verpflichted"),
});
    ...
    <div className="register-form-page h-[90vh] md:h-[88vh] md:py-11 text-center flex flex-col items-center">
      <div className="flex justify-center items-center mb-12 lg:mb-5">
        <div className="flex justify-center items-center title-heading mr-3 rounded-md lg:rounded-lg p-2">
          ...
          <h1 className="text-main-dark-blue font-bold ml-1 md:text-lg xl:text-2xl">
            Ärztin/Arzt
          </h1>
        </div>
        <h1 className="reg-title my-4 md:my-5 text-2xl md:text-3xl xl:text-4xl">
          Registrierung
        </h1>
      </div>
      <form
        onSubmit={handleSubmit(onSubmit)}
        className="register-form mt-10 md:mt-6 lg:mt-12 xl:mt-0 flex flex-col items-center justify-center"
      >
        ...
        <div className="flex flex-col items-center xl:flex-row xl:justify-between w-full 2xl:mt-4">
          ...
          <div className="relative mt-2 w-[330px] xl:min-w-[180px] sm:w-[400px] md:w-[300px] lg:w-[360px] xl:mx-1 xl:w-[300px] focus:border-indigo-600 shadow-sm rounded-lg text-lg">
            ...
            <select
              defaultValue="Branch"
              {...register("branch")}
              className="w-full pl-[3rem] h-12 px-3 py-2 text-md text-main-dark-blue bg-white border rounded-lg shadow-sm outline-none appearance-none focus:ring-offset-2 focus:ring-indigo-600 focus:ring-2"
            >
              <option
                value="Branch"
                disabled
        ...
        <div className="flex flex-col items-center xl:flex-row xl:justify-between w-full 2xl:mt-4">
          ...
          <div className="relative w-[330px] xl:min-w-[180px] sm:w-[400px] md:w-[300px] lg:w-[360px] xl:mx-1 xl:w-[300px] mt-2">
            <button
              className="text-gray-400 absolute right-3 inset-y-0 my-auto active:text-main-dark-blue"
        ...
        <div className="flex flex-col items-center xl:flex-row xl:justify-between w-full 2xl:mt-4">
          <div className="relative w-[330px] xl:min-w-[180px] sm:w-[400px] md:w-[300px] lg:w-[360px] xl:mx-1 xl:w-[300px] mt-2 flex items-center">
            ...
            {isCalendarHidden ? (
              <input
                ...
                {...register("birthDate")}
                onClick={() => setCalendarHidden(!isCalendarHidden)}
                className="w-full pl-[3rem] text-main-dark-blue h-11 pr-3 py-2 appearance-none bg-white outline-none border focus:border-indigo-600 shadow-sm rounded-lg text-lg"
          ...
          <div className="relative mt-2 w-[330px] xl:min-w-[180px] sm:w-[400px] md:w-[300px] lg:w-[360px] xl:mx-1 xl:w-[300px] focus:border-indigo-600 shadow-sm rounded-lg text-lg">
            ...
            <select
              ...
              {...register("gender")}
              className="w-full pl-[3rem] h-11 px-3 py-2 text-md text-main-dark-blue bg-white border rounded-lg shadow-sm outline-none appearance-none focus:ring-offset-2 focus:ring-indigo-600 focus:ring-2"
            >
              <option
                value="Geschlecht"
                disabled
          ...
          <div className="w-[310px] sm:w-[380px] md:w-[280px] lg:w-[340px] xl:min-w-[480px] 2xl:min-w-[646px] 2xl:mt-2">
            <div className="relative max-w-[652px] 2xl:w-[646px] xl:min-w-[420px] text-main-dark-blue w-full min-w-[200px] h-12">
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="w-6 h-6 absolute text-gray-400 left-3 inset-y-0 my-auto"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        <button
          type="submit"
          className="flex justify-center register-button duration-150 mx-auto"
        >
          REGISTRIEREN
        </button>
      </form>
